...
extern uint8_t crayon_memory_load_spritesheet(crayon_spritesheet_t *ss, crayon_palette_t *cp, int8_t palette_id, char *path){
	...
	// if(ss->spritesheet_format == 0x00000000){ //ARGB1555
	// 	ss->spritesheet_format = 0;
	// }
	// if(ss->spritesheet_format == 0x08000000){ //RGB565
	// 	ss->spritesheet_format = 1;
	// }
	// else if(ss->spritesheet_format == 0x10000000){ //ARGB4444
	// 	ss->spritesheet_format = 2;
	// }
	// else if(ss->spritesheet_format == 0x28000000){ //PAL4BPP
	// 	ss->spritesheet_format = 5;
	// }
	// else if(ss->spritesheet_format == 0x30000000){ //PAL8BPP
